...
-- Membuang data untuk tabel borobudur.detail_transaksi: ~3 rows (lebih kurang)
...
-- Membuang data untuk tabel borobudur.kasir: ~1 rows (lebih kurang)
...
-- Membuang data untuk tabel borobudur.paket_makanan: ~2 rows (lebih kurang)
...
-- Membuang data untuk tabel borobudur.transaksi: ~2 rows (lebih kurang)
